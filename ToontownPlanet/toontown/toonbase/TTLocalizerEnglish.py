...
Minnie = 'Minnie'
MakeAToonNameBlacklist = 'MakeAToonNameBlacklist'
Clothes = 'Clothes'
...
Daisy = 'Daisy'
ProfPancake = 'Hiya! Im Prof.Pancake.'
...
ReportPanelBody = 'This feature will send a complete report to a Toontown Planet Moderator. Instead of sending a report, you might choose to do one of the following:\n\n  - Teleport to another district\n  - Use "Ignore" on the toon\'s panel\n\nDo you really want to report %s to a Toontown Planet Moderator?'
...
ReportPanelCategoryBody = 'You are about to report %s. A Toontown Planet Moderator will be alerted to your complaint and will take appropriate action for anyone breaking our rules. Please choose the reason you are reporting %s:'
...
ReportPanelConfirmations = ('You are about to report that %s has used obscene, bigoted or sexually explicit language.',
 ...
 "You are about to report that %s has created a name that does not follow the Toontown Planet rules.",
 'You are about to report that %s has hacked/tampered with the game or used third party software.')
ReportPanelWarning = "We take reporting very seriously. Your report will be viewed by a Toontown Planet Moderator who will take appropriate action for anyone breaking our rules. If your account is found to have participated in breaking the rules, or if you make false reports or abuse the 'Report a Player' system, a Moderator may take action against your account. Are you absolutely sure you want to report this player?"
ReportPanelThanks = 'Thank you! Your report has been sent to a Toontown Planet Moderator for review. There is no need to contact us again about the issue. The moderation team will take appropriate action for a player found breaking our rules.'
ReportPanelRemovedFriend = 'We have automatically removed %s from your Toon Friends List.'
ReportPanelRemovedPlayerFriend = 'We have automatically removed %s as a Player friend so as such you will not see them as your friend in any Toontown Planet product.'
ReportPanelAlreadyReported = 'You have already reported %s during this session. A Toontown Planet Moderator will review your previous report.'
...
CheesyEffectDescriptions = [('Normal Toon', 'you will be normal'),
 ...
 ('Pumpkin Head', 'you will have a pumpkin head'),
 ('Big and White toon', 'you will be big and white'),
 ('Snowman', 'you will have a snowman head'),
 ('Green Toon', 'you will be green')]
...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
 ...
 'CigarSmoke': ["I'll puff you away.",
               'This is a smoking zone.',
               'Smoking kills.',
               "I'll put you out now."],		   
 ...
 'Legalese': ['You must cease and desist.',
              ...
              "The opinions expressed in this attack are not those of Toontown Planet.",
...
SillyPhase3Chatter = ['The Cogs hate how silly Toontown Planet is becoming!',
...
SillyPhase4Chatter = ['Fire hydrants make your Squirt Gags squirtier!',
 ...
 'Enjoy the sillier Toontown Planet!']
...
FriendInviterToonFriendInfo = 'A friend only in Toontown Planet'
FriendInviterPlayerFriendInfo = 'A friend across the Toontown Planet network'
...
LauncherStartingMessage = "Starting Toontown Planet... "
...
LauncherConnectProxyAttempt = 'Connecting to Toontown Planet: %s (proxy: %s) attempt: %s'
LauncherConnectAttempt = 'Connecting to Toontown Planet: %s attempt %s'
LauncherDownloadServerFileList = 'Updating Toontown Planet...'
LauncherCreatingDownloadDb = 'Updating Toontown Planet...'
LauncherDownloadClientFileList = 'Updating Toontown Planet...'
LauncherFinishedDownloadDb = 'Updating Toontown Planet... '
LauncherStartingGame = 'Starting Toontown Planet...'
LauncherRecoverFiles = 'Updating Toontown Planet. Recovering files...'
LauncherCheckUpdates = 'Checking for updates for ' + LauncherProgress
LauncherVerifyPhase = 'Updating Toontown Planet...'
...
AvatarChooserPickAToon = 'Welcome To Toontown Planet!'
AvatarChooserQuit = lLeave
...
EventsPageNewsPaperTitle = 'TOONTOWN Planet TIMES'
...
PartyPlannerTTTimeText = 'Toontown Planet Time'
...
MusicTtiTheme = 'The Toontown Planet Theme'
MusicTtTheme = 'The Toontown Planet Theme'
...
MusicMgTarget = "Soarin' Over Toontown Planet"
...
OptionsPageExitToontown = 'Exit Toontown Planet'
...
OptionsPageExitConfirm = 'Exit Toontown Planet?'
DisplaySettingsTitle = 'Display Settings'
DisplaySettingsIntro = 'The following settings are used to configure the way Toontown Planet is displayed on your computer.  It is usually unnecessary to adjust these unless you are experiencing a problem.'
...
CdrPageTitle = 'Enter a Toontown Planet Code'
...
TutorialMickeyWelcome = 'Welcome to Toontown Planet!'
...
TutorialBook1 = 'The book contains lots of useful information like this map of Toontown Planet.'
...
MakeAToonLastStep = 'Last step before going to Toontown Planet!'
...
WaiterInvasionBulletin3 = lToonHQ + ": The unemployed waiters are invading Toontown Planet!!!"
...
V2InvasionBegin3 = lToonHQ + ': Version 2.0 Cogs have taken over Toontown Planet!!!'
...
V2InvasionBulletin3 = lToonHQ + ': Version 2.0 Cogs have taken over Toontown Planet!!!'
LeaderboardTitle = 'Toon Platoon'
QuestScriptTutorialMickey_1 = 'Toontown Planet has a new citizen! Do you have some extra gags?'
QuestScriptTutorialMickey_2 = 'Sure, %s!'
QuestScriptTutorialMickey_3 = 'Tutorial Tom will tell you all about the Cogs.\x07Gotta go!'
QuestScriptTutorialMickey_4 = "Hello, new citizen! Welcome to Toontown Planet! Come over here so I can tell you what's been going on in town recently. Use the arrow keys to move."
QuestScriptTutorialMinnie_1 = 'Toontown Planet has a new citizen! Do you have some extra gags?'
QuestScriptTutorialMinnie_2 = 'Sure, %s!'
QuestScriptTutorialMinnie_3 = 'Tutorial Tom will tell you all about the Cogs.\x07Gotta go!'
QuestScript101_1 = 'These are Cogs. They are robots that are trying to take over Toontown Planet.'
...
QuestScriptTutorialBlocker_7 = "It's called the SpeedChat Plus button. You need to turn on Speedchat Plus in your Account Manager on the Toontown Planet Website to use it."
...
NPCToonNames = {20000: 'Tutorial Tom',
 ...
 2021: 'Ace',
 2022: 'Buster',
 2023: 'Lead Resistance Ranger Dan',
 2024: 'Prof. Pancake',
 2101: 'Dentist Daniel',
 2102: 'Sheriff Sherry',
 2103: 'Sneezy Kitty',
...
TipDict = {TIP_NONE: ('',),
 TIP_GENERAL: ('Quickly check your ToonTask progress by holding down the "End" key.',
               ...
               'Press the "F9" key to take a screenshot, which will be saved in your Toontown Planet folder on your computer.',
               ...
               'You never need to save your Toontown progress. The Toontown Planet servers continually save all the necessary information.',
...
ResistanceCheesyMenu = 'Cheesy Effect'
ResistanceCheesyItem = '%s'
ResistanceCheesyChat = 'Toons of the World, Get Cheesy With me!'
...
#MineBossTempIntro0 = 'Hello cogs, the mines that way' 
#MineBossTempIntro1 = 'Hmmm wait a second, you dont have Picaxes? your toons!'
#MineBossTempIntro2 = 'Get them Minebots!' 
#MineBossTempDefeat = 'Hmm you have defeated my bots try and beat this!'
#MineBossTempFightIntro = 'Toons listen up! Jump from mine to mine and dodge there attacks and throw pies to drain there power'
#MineBossTempFightDone = 'GAHHHHH!!!! MY POWER!!!!!!!!' 
#MineBossTaunts = ['%s, !Ha you Pesky Toons your mineing skills are terrible',
 #'HA! Only Miners are good in the mines!',
 #'Strike that from the dirt.',
 #'your mineing skills have failed. time you put you in the dirt!',
 #'how bout well squish you like ore'
...
#here are some new cogs for the future
#also some newer cog brands for the future 
MineBot = 'MineBot' 
...
houseNames = {
  HouseGlobals.HOUSE_DEFAULT: 'Classic TTP House',
  HouseGlobals.HOUSE_CABIN: 'TTP Beta House'
}
