...
ctypes.windll.kernel32.SetConsoleTitleA("Toontown Planet Console")

call('color 09', shell =True)

print 'Connecting to Toontown Download Server'
print 'Connected to Toontownplanet.com.arcade14.com Download Server'
