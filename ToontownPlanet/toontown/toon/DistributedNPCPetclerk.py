    ...
    def setMovie(self, mode, npcId, avId, extraArgs, timestamp):
        ...
        if mode == NPCToons.SELL_MOVIE_TIMEOUT:
            ...
            if self.isLocalToon:
                ...
                camera.lerpPosHpr(-5, 9, base.localAvatar.getHeight() - 0.5, -150, -2, 0, 1, other=self, blendType='easeOut')
            if self.isLocalToon:
                taskMgr.doMethodLater(.5, self.popupPetshopGUI, self.uniqueName('popupPetshopGUI'))
