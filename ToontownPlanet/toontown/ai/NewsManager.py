...
promotionalSpeedChatHolidays = [ToontownGlobals.CRASHED_LEADERBOARD]
...
class NewsManager(DistributedObject.DistributedObject):
    ...
    def isHolidayRunning(self, holidayId):
        if holidayId == ToontownGlobals.SILLYMETER_HOLIDAY:
            # hacky! fixes hidden scientists at toon hall
            return True
